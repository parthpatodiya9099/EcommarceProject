...
export default function BagCard({contity,imgurl,color,size,price,Product,onPressP,onPressM}) {
    return (
        <View>
            ...
            <View style={style.bagbox}>
                ...
                <View style={style.disbox}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <TouchableOpacity style={{ width:horizontalScale(40), height:verticalScale(40), borderRadius: 100, backgroundColor: 'white', padding: 10, marginTop:verticalScale(10), marginLeft: 12, borderRadius: moderateScale(40), shadowOpacity: 0.10, shadowRadius: 30, elevation: 9, }} onPress={onPressM}>
